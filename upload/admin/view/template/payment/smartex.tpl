...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-smartex-account" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
  ...
  <div class="container-fluid" id="smartex-page">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $url_action; ?>" method="post" enctype="multipart/form-data" id="form-smartex-account" class="form-horizontal">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-settings">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">  
                  <div id="api-disconnected" class="btn-group <?php if ($smartex_connection === 'connected') { echo ' hidden'; } ?>">
                    <a id="connect_to_smartex" href="<?= $url_connect_livenet; ?>" class="btn btn-primary pair_url"><?php echo $text_connect_to_smartex; ?></a>
                    <button id="connect_to_smartex_dropdown" type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                  ...
                  <div id="api-connected" class="input-group<?php if ($smartex_connection !== 'connected') { echo ' hidden'; } ?>">
                    <p class="form-control-static text-primary"><i class="fa fa-plug"></i> <?php echo $text_connected; ?></p>
                    <span class="input-group-btn">
                      <a id="smartex_disconnect" href="<?php echo $url_disconnect; ?>" class="btn btn-danger"><i class="fa fa-unlink"></i> <?php echo $button_disconnect; ?></a>
                    </span>
                  </div>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <div class="input-group"> <span class="input-group-addon"><i class="fa fa-bolt fa-fw"></i></span>
                    <select name="smartex_risk_speed" id="input-risk-speed" class="form-control">
                      <option value="high"<?php if ($smartex_risk_speed == 'high') { echo ' selected="selected"'; } ?>><?= $text_high; ?></option>
                      <option value="medium"<?php if ($smartex_risk_speed == 'medium') { echo ' selected="selected"'; } ?>><?= $text_medium; ?></option>
                      <option value="low"<?php if ($smartex_risk_speed == 'low') { echo ' selected="selected"'; } ?>><?= $text_low; ?></option>
                    </select>
                  </div>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <label class="radio-inline">            
                    <input type="radio" name="smartex_send_buyer_info" value="1" <?php if ($smartex_send_buyer_info) { ?>checked="checked" <?php } ?>/>
                    <?php echo $text_yes; ?>
                  </label>
                  <label class="radio-inline">            
                    <input type="radio" name="smartex_send_buyer_info" value="0" <?php if (!$smartex_send_buyer_info) { ?>checked="checked" <?php } ?>/>
                    <?php echo $text_no; ?>
                  </label>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <div class="input-group"> <span class="input-group-addon"><i class="fa fa-globe fa-fw"></i></span>
                    <select name="smartex_geo_zone_id" id="input-geo-zone" class="form-control">
                      <option value="0"><?php echo $text_all_zones; ?></option>
                      <?php foreach ($geo_zones as $geo_zone) { ?>
                      <?php if ($geo_zone['geo_zone_id'] == $smartex_geo_zone_id) { ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="smartex_status" id="input-status" class="form-control">
                    <?php if ($smartex_status) { ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="smartex_sort_order" value="<?php echo $smartex_sort_order; ?>" placeholder="<?php echo $entry_sort_order; ?>" id="input-sort-order" class="form-control" />
                </div>
              </div>
              <br>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="smartex_paid_status" class="form-control">
                    <?php foreach ($order_statuses as $order_status) { ?>
                    <?php if ($order_status['order_status_id'] == $smartex_paid_status) { ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="smartex_confirmed_status" class="form-control">
                    <?php foreach ($order_statuses as $order_status) { ?>
                    <?php if ($order_status['order_status_id'] == $smartex_confirmed_status) { ?>
                    <option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
                    <?php } else { ?>
                    <option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
                    <?php } ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="smartex_complete_status" class="form-control">
                    <?php foreach ($order_statuses as $order_status) { ?>
                    <?php if ($order_status['order_status_id'] == $smartex_complete_status) { ?>
                    <option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
                    <?php } else { ?>
                    <option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
                    <?php } ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <div class="input-group"> <span class="input-group-addon"><i class="fa fa-link fa-fw"></i></span>
                    <input type="url" name="smartex_notify_url" id="input-notify-url" value="<?php echo $smartex_notify_url; ?>" placeholder="<?php echo $default_notify_url; ?>" class="form-control" />
                  </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <div class="input-group"> <span class="input-group-addon"><i class="fa fa-link fa-fw"></i></span>
                    <input type="url" name="smartex_return_url" id="input-return-url" value="<?php echo $smartex_return_url; ?>" placeholder="<?php echo $default_return_url; ?>" class="form-control" />
                  </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="smartex_debug" id="input-debug" class="form-control">
                    <?php if ($smartex_debug) { ?>
                    <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                    <option value="0"><?php echo $text_disabled; ?></option>
                    <?php } else { ?>
                    <option value="1"><?php echo $text_enabled; ?></option>
            ...
            <div class="tab-pane" id="tab-log">
              <p>
                <pre id="smartex_logs" class="form-control"><?php echo $log; ?></pre>
              </p>
...
<style>
  ...
  .btn-smartex:hover, .btn-smartex:focus, .btn-smartex:active {
    color: #fff;
  ...
  .smx-log-locale > span > span {
    color: #c55;
  }
  .smx-log-error > .smx-log-level > span {
    color: #a94442;
  }
  .smx-log-warn > .smx-log-level > span {
    color: #aa6708;
  }
  .smx-log-info > .smx-log-level > span {
    color: #31708f;
  }
  .smx-log-trace > .smx-log-level > span {
    color: #777;
  }
...
<script type="text/javascript"><!--
  (function(){
    $('.pair_url').on('click', function(e) {
      $('#connect_to_smartex').addClass('disabled');
      $('#connect_to_smartex_dropdown').addClass('disabled');
    });

    <?php if ($smartex_connection === 'connected') { ?>
    // Poll the connection to Smartex API
    var checkConnection = function() {
      $.get('<?php echo $url_connected; ?>', {dataType: 'json'}).always(function(data) {
        if (data.error) {
          ...
          $('.alert').alert('close')
          $('#smartex-page').prepend('<div class="alert alert-danger fade in"><i class="fa fa-exclamation-circle"></i> '+data.error+'<button type="button" class="close" data-dismiss="alert">&times;</button></div>');
          return;
        }
